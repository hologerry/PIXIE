    ...
    for i, batch in enumerate(tqdm(posedata, dynamic_ncols=True)):
        if i % 1 == 0:
            ...
            visdict = visualizer.render_results(
                opdict, data["body"]["image_hd"], moderator_weight=moderator_weight, overlay=True
            )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-i",
        "--inputpath",
        default="TestSamples/body/woman-in-white-dress-3830468.jpg",
        type=str,
