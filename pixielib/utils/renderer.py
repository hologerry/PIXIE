...
def set_rasterizer(type="pytorch3d"):
    if type == "pytorch3d":
        ...
        from standard_rasterize_cuda import standard_rasterize  # type: ignore
...
class SRenderY(nn.Module):
    ...
    def forward(
        self, vertices, transformed_vertices, albedos, lights=None, light_type="point", background=None, h=None, w=None
    ):
        """
        -- Texture Rendering
